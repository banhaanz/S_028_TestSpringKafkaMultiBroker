...
import com.ktb.tungngern.ycyd.tnycydlistenerpaymentresult.util.DatetimeUtils;
import com.ktb.tungngern.ycyd.tnycydlistenerpaymentresult.util.FunctionUtils;
import com.ktb.tungngern.ycyd.tnycydlistenerpaymentresult.util.StringUtils;
...
@Service
@Slf4j
public class NotificationTnPepService {
    ...
    public NotificationProducerBean buildNotificationProducerBean(YCYDTxnConsumer ycydTxnConsumer)
    {
        ...
        String messageBody = StringUtils.replace(body,
                ...
                new String[]{FunctionUtils.formatCustomerName(ycydTxnConsumer.getPayerName()),
                        createAt});
